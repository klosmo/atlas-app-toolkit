...
import (
	...
	"github.com/klosmo/atlas-app-toolkit/v2/logging/mocks"
	"github.com/klosmo/atlas-app-toolkit/v2/requestid"
)
...
func TestUnaryClientInterceptor(t *testing.T) {
	...
	// https://github.com/klosmo/atlas-app-toolkit/issues/191
